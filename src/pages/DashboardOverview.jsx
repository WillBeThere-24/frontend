  ...
  return (
    <main className='w-full'>
      ...
      <div className='block md:flex gap-12 justify-center mt-8 text-center text-wybt-primary flex-col sm:flex-row w-full items-centher'>
        ...
        <div className='text-2xl font-bold border border-wybt-primary py-12  md:px-20 px-12  rounded-md w-full md:w-full mt-6 md:mt-0'>
      ...
      <Link
        ...
        className='bg-wybt-primary text-white md:px-10 py-4 my-20  rounded-md mt-10 block  font-bold md:w-fit w-full text-center'
      >
        Create New Event
      </Link>
    </main>
