  ...
  return (
    <>
      <nav className={styles.navBarContainer}>
        ...
        <div>
          <NavLink className={styles.sidelineLeft}>
            <button className={styles.navBarBtn}>Register</button>
          </NavLink>
        </div>
        {/* Mobile Menu */}
        ...
        {isOpen && (
          <div
            className={`${styles.mobileNav} transform ${
          ...
          >
            ...
            <div>
              <NavLink className={styles.sidelineLefth}>
                <button className={styles.navBarBtnMobile}>Register</button>
              </NavLink>
            </div>
          </div>
        )}
