...
const styles = {
  ...
  sidelineLeft: `flex-r md:border-l-[1px] border-wybt-neutralBlack md:pl-20 block pl-10`,
  sidelineRight: `fle md:border-r-[1px] border-wybt-neutralBlack md:pr-20 block py-2 pr-10`,
  mobileNav: `flex flex-col top-0 bg-wybt-white p-20 w-3/4 absolute right-0 h-screen sm:hidden gap-5   `,
  navBarOverlay: `bg-wybt-neutralBlack h-screen absolute top-0 w-screen left-0 opacity-80 cursor-pointer `
}
const NavBar = () => {
  ...
  return (
    <>
      <nav className={styles.navBarContainer}>
        <div className="">
          <span className={styles.sidelineRight}>WYBT</span>
        </div>
