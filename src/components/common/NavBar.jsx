...
<<<<<<< HEAD
                href="/"
                className={` justify-center flex flex-col items-center z- min-w-[6px] relative z-5 `}
              >
...
<<<<<<< HEAD
        ...
        <div>
          <NavLink
            to="/register"
            className={`flex-r md:border-l-[1px] border-wybt-neutral-black md:pl-20 block pl-10  py-1 max-h-10`}
          >
            <button
        ...
        <div className="font-extrabold text-3xl block sm:hidden z-50 cursor-pointer">
          {isOpen ? (
            <CloseMenuBtn handleClick={handleMenuToggle} className="size-8" />
          ) : (
            <Harmburger handleClick={handleMenuToggle} className=" size-8" />
          )}
        </div>
=======
          <NavLink to=''>Event Details</NavLink>
...
>>>>>>> 20fb1a6947d45855be0dd7c36ff30d38513ebcbf
        ...
        {isOpen && (
          <div
<<<<<<< HEAD
            className={`flex flex-col top-0 bg-wybt-white p-16 w-5/6 fixed right-0 h-screen sm:hidden gap-6 z-40 pt-36 itemsg-center ${isOpen
              ? "translate-x-xfull duration-150 transform translate-x-4"
              : "translate-x-full transitfion-all duration-500 ease-in-out"
              } `}
          >
            <div className={`flex sm:hidden flex-col  z-70 gap-4 text-[1.2rem] `}>
...
=======
            className={`flex flex-col top-0 bg-wybt-white p-16 w-full fixed right-0 h-screen sm:hidden gap-5 z-40 justify-center items-center ${
              isOpen
                ? "translate-x-xfull duration-150 transform translate-x-4"
                : "translate-x-full transitfion-all duration-500 ease-in-out"
            } `}
          >
            <div className={`flex sm:hidden flex-col  z-70 gap-3 text-[1rem]`}>
              <NavLink to=''>Event Details</NavLink>
              <NavLink to='/dashboard'>Dashboard</NavLink>
              <NavLink to=''>Contact Us</NavLink>
            </div>
